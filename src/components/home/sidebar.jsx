...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { label: "Staff Allotment", icon: "/photos/staff.png", href: "/staff-allotment" },
    { label: "Staff Salary & Deductions", icon: "/photos/salary.png", href: "/salary" },
    { label: "Tickets and Queries", icon: "/photos/tickets.png", href: "/tickets" },
