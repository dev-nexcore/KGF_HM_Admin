...
export default function AuditLogsSection() {
  ...
  return (
    <div className="px-4 sm:px-6 py-10 max-w-full">
      <h2 className="text-3xl sm:text-4xl font-bold text-black border-l-4 border-red-600 pl-2 mb-4">
        Audit Logs
      </h2>

      <div className="bg-[#A4B494] rounded-xl p-6 shadow-md overflow-x-auto">
