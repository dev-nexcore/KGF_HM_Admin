  ...
  return (
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <button className="px-4 py-2 bg-transparent text-[#7BAC4A] font-semibold shadow-lg rounded-md text-sm cursor-pointer hover:bg-green-50">
              Export Report
            </button>
    ...
    <td colSpan="9" className="py-2"></td> {/* spacer row */}
              ...
              <tr className="bg-white">
                ...
                <th className="font-bold text-gray-900 px-4 py-4 text-center">Basic Salary</th>
                <th className="font-bold text-gray-900 px-4 py-4 text-center">Tax</th>
                <th className="font-bold text-gray-900 px-4 py-4 text-center">PF</th>
                <th className="font-bold text-gray-900 px-4 py-4 text-center">Loan Deduction</th>
                <th className="font-bold text-gray-900 px-4 py-4 text-center">Net Salary</th>
                <th className="font-bold text-gray-900 px-4 py-4 text-center">Status</th>
            ...
            <tbody>
              {staffData.map((staff, index) => (
                <tr key={index} className="relative">
                  ...
                  <td className="px-4 py-5 text-center">{staff.tax}</td>
                  <td className="px-4 py-5 text-center">{staff.pf}</td>
